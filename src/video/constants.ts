...
export const SCENE_2_DURATION = 210; // 7 seconds - Overall Top Picks
export const SCENE_3_DURATION = 120; // 4 seconds - Category 1
export const SCENE_4_DURATION = 120; // 4 seconds - Category 2
export const SCENE_5_DURATION = 120; // 4 seconds - Category 3
export const SCENE_6_DURATION = 60; // 2 seconds - Closing
